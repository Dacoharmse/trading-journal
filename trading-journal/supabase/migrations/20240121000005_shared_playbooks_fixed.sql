-- ============================================================================
-- SHARED PLAYBOOKS MIGRATION (FIXED)
-- ============================================================================
-- Allows mentors to share their playbooks with students
-- First ensures playbooks table has the necessary columns
-- ============================================================================

-- Add created_at and updated_at to playbooks if they don't exist
DO $$
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE public.playbooks ADD COLUMN created_at TIMESTAMPTZ DEFAULT NOW();
    END IF;
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE public.playbooks ADD COLUMN updated_at TIMESTAMPTZ DEFAULT NOW();
    END IF;
END $$;

-- Now create shared_playbooks table
