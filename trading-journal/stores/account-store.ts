      ...
      addAccount: async (input: AccountInput) => {
        ...
        try {
          ...
          const newAccount: TradingAccount = {
            ...
            riskLimitType: data.risk_limit_type || 'percentage',
            riskLimitValue: data.risk_limit_value ? Number(data.risk_limit_value) : 2.0,
            sessionRiskEnabled: data.session_risk_enabled ?? false,
