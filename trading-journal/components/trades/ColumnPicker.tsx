...
const AVAILABLE_COLUMNS = [
  ...
  { id: 'entry_price', label: 'Entry Price', default: false },
  { id: 'stop_price', label: 'Stop Loss (price)', default: false },
  { id: 'exit_price', label: 'Exit Price', default: false },
  { id: 'strategy', label: 'Strategy', default: false },
  { id: 'confluences', label: 'Confluences', default: false },
  { id: 'mae_r', label: 'MAE (R)', default: false },
  { id: 'mfe_r', label: 'MFE (R)', default: false },
