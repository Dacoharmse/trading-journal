            ...
            <div key={item.grade} className="space-y-2">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="w-8 text-center font-bold text-slate-900 dark:text-slate-50">
                    {item.grade}
                  </span>
                  {hasData && (
              ...
              <div className="flex gap-2">
                <div className="flex-1">
                  <div className="h-8 w-full overflow-hidden rounded bg-slate-200 dark:bg-slate-800">
                    {hasData && (
                      <div
                        className={cn(
                          'h-full transition-all',
                          gradeColors[item.grade] || 'bg-slate-400'
                        )}
