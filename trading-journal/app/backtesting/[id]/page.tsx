  ...
  return (
    <div className="flex-1 bg-gradient-to-br from-slate-50 via-slate-100 to-slate-50 p-6 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="mx-auto w-full max-w-7xl space-y-6">
        ...
        {backtests.length === 0 ? (
          <div className="rounded-xl border border-dashed border-slate-300 bg-white p-12 text-center dark:border-slate-700 dark:bg-slate-900/60">
          ...
          <>
            {/* Tab Navigation */}
            <div className="flex gap-2 rounded-lg border border-slate-200/70 bg-white/80 p-1 dark:border-slate-800/60 dark:bg-slate-900/60">
              <button
            ...
            {/* Equity Curve */}
            <div className="rounded-lg border border-slate-200/70 bg-white/80 p-6 dark:border-slate-800/60 dark:bg-slate-900/60">
